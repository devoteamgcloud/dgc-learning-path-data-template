resource "google_storage_bucket" "sandbox-achaabene_magasin_cie_landing" {
...
resource "google_storage_bucket" "sandbox-achaabene_magasin_cie_utils" {
  project  = var.project_id
...
resource "google_storage_bucket_object" "queries" {
  ...
  source   = each.value
  bucket   = google_storage_bucket.sandbox-achaabene_magasin_cie_utils.name
