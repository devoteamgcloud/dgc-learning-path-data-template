...
def hello_gcs(event: dict, context: dict):
    ...
    *subfolder, file = blob_path.split(os.sep)
    ...
    try:
        ...
        assert first_part in FILES_AND_EXTENSION_SPEC.keys(
        ...
        assert file_extention in FILES_AND_EXTENSION_SPEC[
            first_part], "File extension -> false"
...
if __name__ == '__main__':
    ...
    for file_name in os.listdir(init_files_path):
        ...
        mock_context = {}
        hello_gcs(mock_event, mock_context)
